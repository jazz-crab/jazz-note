...
const ru: Record<string, string> = {
  ...
  'sync.gen': 'Создать пароль',
  'sync.gen.hint': 'Сгенерирует 12-символьный пароль и применит его на сервере',
  'sync.generating': 'Применение пароля...',
  'sync.gen.done': 'Пароль создан и применён на сервере',
  'sync.gen.failed': 'Не удалось применить пароль на сервере: {error}',
  ...
  'sync.ssh': 'Доступ к серверу по SSH',
  'sync.ssh.host': 'Хост SSH',
  'sync.ssh.user': 'Пользователь SSH',
  'sync.ssh.key': 'Путь к ключу SSH',
  'sync.ssh.key.hint': 'Пусто — поиск в ~/.ssh автоматически',
  'close': 'Закрыть',
}
...
const en: Record<string, string> = {
  ...
  'sync.gen': 'Generate password',
  'sync.gen.hint': 'Generates a 12-character password and applies it to the server',
  'sync.generating': 'Applying password...',
  'sync.gen.done': 'Password created and applied to the server',
  'sync.gen.failed': 'Failed to apply password to server: {error}',
  'sync.share': 'Share',
  ...
  'sync.ssh': 'SSH server access',
  'sync.ssh.host': 'SSH host',
  'sync.ssh.user': 'SSH user',
  'sync.ssh.key': 'SSH key path',
  'sync.ssh.key.hint': 'Empty — searched in ~/.ssh automatically',
  'close': 'Close',
}
